...
public interface AdminCarRepository extends JpaRepository<CarVO, Integer> {
    ...
    public void updateAdminCar(String c_name,String c_brand,String c_year,String c_color,String c_type,String c_type2,String c_oil,double c_price,String c_img,int c_num);

...
<div class="Badmin">
	<div class="Admin">
		...
		<article id="admin_show">
			<h1>공 지 사 항</h1>
			<div class="clear"></div>
				<form method="post" action="admin_qna_reply_edit_ok" onsubmit="return qna_reply_check();">
					...
					<div id="Bag">
						...
						<table id="ag_t" border="1">
							<tr>
								<th>제목</th>
								<td><input name="cq_title" id="cq_title" size="97" style="height: 32px;" value="${q.cq_title}" readonly ></td>
							</tr>
							<tr>
								<th>답변</th>
								<td>
									<textarea name="cq_cont" id="cq_cont" rows="25" cols="92">${q.cq_cont}</textarea>
								</td>
							</tr>
						</table>

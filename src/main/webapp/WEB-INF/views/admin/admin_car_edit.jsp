     			...
     			<input type="hidden" name="page" value="${page}" />
					<div id="Bag">
						...
						<table id="ag_t">
							<tr>
								<th>차량 이름</th>
								<td><input name="c_name" id="c_name" size="14" value="${c.c_name}"/></td>
							</tr>
							<tr>
								<th>차량 브랜드</th>
								<td><input name="c_brand" id="c_brand" size="14" value="${c.c_brand}" /></td>
							</tr>
							<tr>
								<th>차량 년식</th>
								<td><input name="c_year" id="c_year" size="14" /value="${c.c_year}"></td>
							</tr>
							<tr>
								<th>차량 색상</th>
								<td><input name="c_color" id="c_color" size="14" value="${c.c_color}"/></td>
							</tr>
							<tr>
								<th>차량 상세차종</th>
								<td><input name="c_type" id="c_type" size="14" value="${c.c_type}" /></td>
							</tr>
							<tr>
								<th>차량 차종</th>
								<td>
							...
							<tr>
								<th>차량 기름</th>
								<td><input name="c_oil" id="c_oil" size="14" value="${c.c_oil}"/></td>
							</tr>
							<tr>
								<th>차량 가격</th>
								<td><input name="c_price" id="c_price" size="14" value="${c.c_price}"/></td>
							</tr>
							<tr>
								<th>차량 이미지</th>
								<td><input type="file" id="c_img" name="c_img" value="${c.c_img}"/></td>
							</tr>
						</table>
